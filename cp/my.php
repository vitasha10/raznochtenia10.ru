...
if(!isset($_COOKIE['userid'])){
    ...
    if (isset($_POST["pass2"])) {
        $sql = mysqli_query($link, "UPDATE `peoples` SET `name`='{$_POST['name2']}', `pass` = '{$_POST['pass2']}', `ava` = '{$_POST['ava1']}',`birthday`='{$_POST['birthday1']}',`vk` = '{$_POST['vk1']}' WHERE `userid`={$_COOKIE['userid']}");
    }
